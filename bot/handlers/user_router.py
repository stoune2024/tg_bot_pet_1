...
from bot.db_handler.db_funk import get_user_data, insert_user
from bot.keyboards.kbs import main_kb, home_page_kb
from bot.utils.utils import get_refer_id, get_now_time
from aiogram.utils.chat_action import ChatActionSender

user_router = Router()

universe_text = (
    'Чтоб получить информацию о своем профиле воспользуйся кнопкой "Мой профиль" или специальной '
...
async def get_profile(message: Message):
    async with ChatActionSender.typing(bot=bot, chat_id=message.from_user.id):
        ...
        text = (
            ...
            f"<code>https://t.me/mchubaroff_pet_1_bot?start={message.from_user.id}</code>"
        )
